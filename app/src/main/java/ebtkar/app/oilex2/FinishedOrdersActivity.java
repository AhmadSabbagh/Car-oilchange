...
import ebtkar.app.oilex2.adapters.FinishedOilRequestsAdapter;
...
public class FinishedOrdersActivity  extends RootActivity {
    ...
    void init(final int t){
        ...
        BackgroundServices.getInstance(this).CallPost(APIUrl.SERVER + "getdata_orders_In_service",args
                    ...
                    public void doTask(String s) {
                        if(s.equals("")){
                            if(t<20)init(t+1);
                                ...
                                Toast.makeText(FinishedOrdersActivity.this, R.string.server_error, Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        }else{
                            try {
                                ...
                                if(array.length()>0) {
                                    ...
                                    recyclerView.setLayoutManager(new LinearLayoutManager(FinishedOrdersActivity.this));
                                    recyclerView.setAdapter(new FinishedOilRequestsAdapter(arraylist, FinishedOrdersActivity.
                                            this));
                                }else{
                                    Toast.makeText(FinishedOrdersActivity.this, R.string.no_results_found, Toast.LENGTH_SHORT).show();
                                }
