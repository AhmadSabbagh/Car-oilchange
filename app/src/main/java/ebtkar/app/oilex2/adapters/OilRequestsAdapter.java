...
public class OilRequestsAdapter extends BasicRecycleviewAdapter {
    ...
    public OilRequestsAdapter(ArrayList cats, Activity c) {
        super(cats, c);
    }
    ...
    public void onBindViewHolder(@NonNull MyView holder, int position) {
       final OilRequest p = (OilRequest)cats.get(position);
        ...
        if(p.getPhone()!=null && !p.getPhone().equals("null") && !p.getPhone().equals(""))
        v.phone.setText(context.getString(R.string.cus_phone) + p.getPhone());
        else
            v.phone.setVisibility(View.GONE);
...
v.body.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        ...
        if ( !manager.isProviderEnabled( LocationManager.GPS_PROVIDER ) ) {
            ...
            Intent ii = new Intent(context , MapsActivity.class);
